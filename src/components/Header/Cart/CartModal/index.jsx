...
function CartModal({ toggleModal }) {
  ...
  return (
    <>
      ...
      />
      <section className="w-11/12 sm:w-3/4 md:w-1/2 h-1/2 bg-white flex flex-col fixed top-1/2 left-1/2 p-5 -translate-x-1/2 -translate-y-1/2 rounded-md move-up-modal z-20">
